...
export const LoginView = () => {
  const { form, handleLogin, navigate, isPending } = useLoginViewModel();
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleLogin)}>
            ...
            <CardContent className="flex flex-col gap-4">
              ...
              <div className="grid w-full gap-4">
                <div className="flex flex-col space-y-0.5">
                  ...
                  />
                  <Button type="button" tabIndex={6} variant="link" className="text-xs justify-end px-0">
            ...
            <CardFooter className="flex flex-col items-start gap-1">
              <Button tabIndex={6} className="w-full bg-teal-500 hover:bg-teal-800 font-bold">
                {isPending ? <AiOutlineLoading3Quarters className="animate-spin" /> : "Sign In"}
              </Button>
              ...
              <div className="flex items-center">
                ...
                <Button type="button" tabIndex={7} variant="link" className="font-bold text-xs px-1" onClick={() => navigate("/register")}>
                  Register here
                </Button>
              </div>
            </CardFooter>
