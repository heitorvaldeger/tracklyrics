...
export const LanguageProvider = ({ children }: PropsWithChildren) => {
  ...
  const { data: languages } = useSWRImmutable([ENDPOINTS.LANGUAGES, API_METHODS.GET], ([url, method]) => request<Language[]>(method, url));
